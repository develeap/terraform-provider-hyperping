...
page_title: "hyperping_outages Data Source - hyperping"
subcategory: ""
description: |-
...
- `filter` (Attributes) Filter criteria for outages (see [below for nested schema](#nestedatt--filter))
...
- `monitor_uuid` (String) Filter by specific monitor UUID
- `name_regex` (String) Regular expression to match outage monitor names
