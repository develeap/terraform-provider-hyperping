...
page_title: "hyperping_healthchecks Data Source - hyperping"
subcategory: ""
description: |-
...
- `filter` (Attributes) Filter criteria for healthchecks (see [below for nested schema](#nestedatt--filter))
...
- `name_regex` (String) Regular expression to match healthcheck names
